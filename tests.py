...
def cpfl():
    try:
        fullNewPath = "/Users/Игорь/File_Manager/test_new.txt"
...
def rnmfl():
    try:
        fullNewPath = "/Users/Игорь/File_Manager/test_.txt"
...
def mvfl():
    try:
        fullNewPath = "/Users/Игорь/File_Manager/test_new.txt"
        fullNewPath2 = "/Users/Игорь/File_Manager/test_new_new.txt"
...
def dlfl():
    try:
        filePath = "/Users/Игорь/File_Manager/test_.txt"
        os.remove(filePath)
        return True
    except FileExistsError:
        print("file does not exist")
